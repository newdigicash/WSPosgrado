...
/**
 * SgpMencionesAsignaturasId generated by hbm2java
 */
public class SgpMencionesAsignaturasId  implements java.io.Serializable {


     private int mencionId;
     private int mallaId;
     private int placurId;
     private int curposId;
     private int asignaturaId;

    public SgpMencionesAsignaturasId() {
    }

    public SgpMencionesAsignaturasId(int mencionId, int mallaId, int placurId, int curposId, int asignaturaId) {
    ...
    public SgpMencionesAsignaturasId(int mallaId, int placurId, int curposId, int asignaturaId) {
        this.mallaId = mallaId;
        this.placurId = placurId;
        this.curposId = curposId;
        this.asignaturaId = asignaturaId;
    ...
    public int getMencionId() {
        return this.mencionId;
    }
    
    public void setMencionId(int mencionId) {
        this.mencionId = mencionId;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SgpMencionesAsignaturasId) ) return false;
		 SgpMencionesAsignaturasId castOther = ( SgpMencionesAsignaturasId ) other; 
         
		 return (this.getMencionId()==castOther.getMencionId())
 ...
 && (this.getAsignaturaId()==castOther.getAsignaturaId());
   ...
   public int hashCode() {
         ...
         result = 37 * result + this.getMencionId();
