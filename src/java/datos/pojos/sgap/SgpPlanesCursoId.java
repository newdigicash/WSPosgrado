...
/**
 * SgpPlanesCursoId generated by hbm2java
 */
public class SgpPlanesCursoId  implements java.io.Serializable {


     private int id;
     private int curposId;

    public SgpPlanesCursoId() {
    }

    public SgpPlanesCursoId(int id, int curposId) {
       this.id = id;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SgpPlanesCursoId) ) return false;
		 SgpPlanesCursoId castOther = ( SgpPlanesCursoId ) other; 
