...
/**
 * SgpMallasId generated by hbm2java
 */
public class SgpMallasId  implements java.io.Serializable {
    ...
    public SgpMallasId(int id, int placurId, int curposId) {
       this.id = id;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SgpMallasId) ) return false;
		 SgpMallasId castOther = ( SgpMallasId ) other; 
