...
/**
 * SgpHorariosOfertasId generated by hbm2java
 */
public class SgpHorariosOfertasId  implements java.io.Serializable {
    ...
    public SgpHorariosOfertasId() {
    }

    public SgpHorariosOfertasId(int id, int curposId, int edicionId, int asignaturaId, int grupo) {
       this.id = id;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SgpHorariosOfertasId) ) return false;
		 SgpHorariosOfertasId castOther = ( SgpHorariosOfertasId ) other; 
